// downloaded from https://cdn.jsdelivr.net/npm/d3-org-chart@2
!(function (t, e) {
  ...
  (t.OrgChart = class {
    ...
    addNode(e) {
      ...
      var t = a.allNodes.filter(
          ({ data: t }) => a.nodeId(t) === a.nodeId(e)
        )[0],
        n = a.allNodes.filter(
          ({ data: t }) => a.nodeId(t) === a.parentNodeId(e)
        )[0];
      return (
        t
          ? console.log(
              `ORG CHART - ADD - Node with id "${a.nodeId(
                e
              )}" already exists in tree`
            )
          : n
          ? (e._centered && !e._expanded && (e._expanded = !0),
            a.data.push(e),
            this.updateNodesState())
          : console.log(
              `ORG CHART - ADD - Parent node with id "${a.parentNodeId(
                e
    ...
    setLayouts({ expandNodesFirst: t = !0 }) {
      ...
      (i.root = M.stratify()
        ...
        i.root.children &&
          (t && i.root.children.forEach(this.expand),
